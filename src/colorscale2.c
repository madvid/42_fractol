...
/*   Updated: 2021/04/07 18:50:53 by mdavid           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
** PARAMETRES:	level [int]: iteration level associated to the pixel
** DESCRIPTION:
**	Traduces the iteration level of the pixel into a RGB value
**	according to the coolwarm colorscale.
** RETOUR:
**	ret [int]: RGB value encoded on a integer.
*/
...
** DESCRIPTION:
**	Traduces the iteration level of the pixel into a RGB value
**	according to the blues colorscale.
** RETOUR:
**	ret [int]: RGB value encoded on a integer.
*/
...
** DESCRIPTION:
**	Traduces the iteration level of the pixel into a RGB value
**	according to the reds colorscale.
** RETOUR:
**	ret [int]: RGB value encoded on a integer.
*/
...
** DESCRIPTION:
**	Traduces the iteration level of the pixel into a RGB value
**	according to the greens colorscale.
** RETOUR:
**	ret [int]: RGB value encoded on a integer.
*/
