...
/*   Updated: 2021/04/07 18:47:09 by mdavid           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
**	according to the viridis colorscale.
** RETOUR:
...
** DESCRIPTION:
**	Traduces the iteration level of the pixel into a RGB value
**	according to the magma colorscale.
** RETOUR:
**	ret [int]: RGB value encoded on a integer.
*/
...
** DESCRIPTION:
**	Traduces the iteration level of the pixel into a RGB value
**	according to the YlOrBr colorscale.
** RETOUR:
**	ret [int]: RGB value encoded on a integer.
*/
...
** DESCRIPTION:
**	Traduces the iteration level of the pixel into a RGB value
**	according to the mako colorscale.
** RETOUR:
**	ret [int]: RGB value encoded on a integer.
*/
